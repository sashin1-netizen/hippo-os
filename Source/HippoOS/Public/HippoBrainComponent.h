...
public:
    ...
    UPROPERTY(BlueprintReadOnly, Category="Hippo|Brain") EHippoAction CurrentAction = EHippoAction::Idle;
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Hippo|Brain") float DecisionIntervalSeconds = 2.0f;
    UPROPERTY(BlueprintAssignable) FHippoActionSelected OnActionSelected;

    UFUNCTION(BlueprintCallable) void DecideNow();
    UFUNCTION(BlueprintPure) float ScoreAction(EHippoAction Action) const;
